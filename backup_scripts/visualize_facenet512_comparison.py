...
def main():
    parser = argparse.ArgumentParser(description='Visualize FaceNet512 face comparison results')
    ...
    parser.add_argument('--output', type=str, default='results/facenet512_comparison.png',
    ...
    try:
        ...
        plt.suptitle(f"FaceNet512 - Similarity: {similarity:.4f} ({match_text})", 
