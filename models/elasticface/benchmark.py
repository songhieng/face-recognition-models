...
def extract_embeddings(model, img_paths):
    """
    Extract embeddings from images using ElasticFace.
...
def benchmark(dataset_dir, model, threshold=0.5):
    """
...
def evaluate_protocol_splits(dataset_dir, protocol_dir, model, threshold=0.5):
    """
